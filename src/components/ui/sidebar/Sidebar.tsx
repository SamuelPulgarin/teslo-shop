        ...
        <div>
            ...
            <nav
                ...
                <div className='relative mt-14'>
                    ...
                    <input type="text" name="" id="" placeholder='Buscar' className='w-full bg-gray-50 rounded pl-10 py-1 pr-10 border-b-2 text-xl border-gray-200 focus:outline-none focus:border-blue-500' />
